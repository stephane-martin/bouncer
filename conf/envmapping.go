...
func SetEnvMapping(v *viper.Viper) {
	...
	v.BindEnv("http.original_server_header", "NAL_ORIGINAL_SERVER_HEADER")
	...
	v.BindEnv("http.login_tpl_path", "NAL_LOGIN_TPL_PATH")
	v.BindEnv("http.error_message", "NAL_ERROR_MESSAGE")
	...
	v.BindEnv("cache.cookie_header", "NAL_COOKIE_HEADER")
	v.BindEnv("cache.cookie_name", "NAL_COOKIE_NAME")
